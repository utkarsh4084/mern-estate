...
import { updateUserStart, updateUserSuccess, updateUserFailure,
          ...
          signOutUserStart, signOutUserSuccess, signOutUserFailure } from '../app/user/userSlice.js';
...
export default function Profile() {
  ...
  const [showListingsError, setShowListingErrors] = React.useState(false);
  ...
  const handleSignOut = async () => {
    try {
      ...
      dispatch(signOutUserFailure(error.essage))
    }
  }
  ...
  return (
    <div className='p-3 max-w-lg mx-auto'>
      ...
      <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
        ...
        <Link to="/create-listing" className="bg-green-700 p-3 text-white rounded-lg text-center uppercase hover:opacity-95">
          Create Listing
        </Link>
      </form>
